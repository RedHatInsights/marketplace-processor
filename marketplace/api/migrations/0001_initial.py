    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source', models.UUIDField(null=True)),
                ('source_metadata', models.TextField(null=True)),
                ('state', models.CharField(choices=[('pending', 'pending'), ('new', 'new'), ('retry_validation', 'retry_validation'), ('failed_validation', 'failed_validation'), ('validated', 'validated'), ('started', 'started'), ('hosts uploaded', 'hosts uploaded'), ('failed to upload metrics', 'failed to upload metrics')], default='new', max_length=28)),
                ('retry_type', models.CharField(choices=[('time', 'time'), ('git commit', 'git commit')], default='time', max_length=10)),
                ('state_info', models.TextField(null=True)),
                ('retry_count', models.PositiveSmallIntegerField(null=True)),
                ('last_update_time', models.DateTimeField(null=True)),
